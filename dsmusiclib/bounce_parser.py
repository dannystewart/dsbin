...
class BounceParser:
    ...
    def find_bounces(cls, directory: str | Path, recursive: bool = False) -> list[Bounce]:
        ...
        Note:
            ...
            - By default, it only searches the specified directory.
                Set recursive=True to include subdirectories.
            - Be cautious when using recursive search in directories with many subdirectories,
                as it may be slower and include unwanted files.
        """
        path = Path(directory)
