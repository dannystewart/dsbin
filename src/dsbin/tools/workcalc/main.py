...
from dsbin.tools.workcalc.bounce_plugin import BounceDataSource
from dsbin.tools.workcalc.git_plugin import GitDataSource
from dsbin.tools.workcalc.sessions import SessionAnalyzer
from dsbin.tools.workcalc.stats import WorkStats
from dsbin.tools.workcalc.streaks import StreakAnalyzer
from dsbin.tools.workcalc.summary import SummaryAnalyzer
from dsbin.tools.workcalc.time import TimeAnalyzer, TimeSpan
...
if TYPE_CHECKING:
    ...
    from dsbin.tools.workcalc.plugin import DataSourcePlugin
    from dsbin.tools.workcalc.work_item import WorkItem
